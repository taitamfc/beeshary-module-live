...
{elseif (isset($tax_breakdowns))}
	<table id="tax-tab" width="100%">
		<thead>
			<tr>
				<th class="header small">{l s='Tax Detail' mod='mpsellerinvoice'}</th>
				<th class="header small">{l s='Tax Rate' mod='mpsellerinvoice'}</th>
				{if $display_tax_bases_in_breakdowns}
					<th class="header small">{l s='Base price' mod='mpsellerinvoice'}</th>
				{/if}
				<th class="header-right small">{l s='Total Tax' mod='mpsellerinvoice'}</th>
			</tr>
		</thead>
		<tbody>
						...
						<tr>
							...
							{if $display_tax_bases_in_breakdowns}
								<td class="right white">
									...
									{$line.total_unit_price_tax_excl}
								</td>
							{/if}
		...
		{if !$has_line}
			<tr>
				<td class="white center" colspan="{if $display_tax_bases_in_breakdowns}4{else}3{/if}">
					{l s='No taxes' mod='mpsellerinvoice'}
				</td>
			</tr>
		{/if}
