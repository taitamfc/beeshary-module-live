...
{if isset($products) && $products}
    ...
    {/if}
        {foreach from=$products item=product name=products}
            <li class="cat-{$product.id_category_default}-{$product.category} ajax_block_product{if isset($formAtts.use_animation) && $formAtts.use_animation} has-animation{/if} product_block 
