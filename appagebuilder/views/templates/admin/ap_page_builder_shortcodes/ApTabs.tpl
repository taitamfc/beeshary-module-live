...
{if !isset($isSubTab)}
<div {if !isset($apInfo)}id="default_ApTabs"{/if} class="widget-row clearfix ApTabs{if isset($formAtts)} {$formAtts.form_id|escape:'html':'UTF-8'}{/if}{if isset($formAtts.active) && !$formAtts.active} deactive{else} active{/if}" data-type='ApTabs'>
