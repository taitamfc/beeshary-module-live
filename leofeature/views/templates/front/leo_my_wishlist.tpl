...
{block name='content'}
	<section id="main">
		{if {hook h="displayMpMenu"}}<div class="mp_custom_account">{/if}{hook h="displayMpMenu"}
		<div id="mywishlist">
		...
		{if {hook h="displayMpMenu"}}</div>{/if}
	</section>
	{if {hook h="displayMpMenu"}}
		<footer class="page-footer custom">
			<a href="/module/marketplace/dashboard" class="account-link btn">
					<i class="material-icons"></i>
					<span>Retour sur votre tableau de bord</span>
			</a>
			<a href="/" class="account-link btn">
				<i class="material-icons"></i>
				<span>Accueil</span>
			</a>
		</footer>
