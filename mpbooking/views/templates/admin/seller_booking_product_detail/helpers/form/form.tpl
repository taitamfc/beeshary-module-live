		...
		<div class="tabs wk-tabs-panel">
			...
			<div class="tab-content panel collapse in">
				<div class="tab-pane active" id="wk-information">
					...
					<!--Start custom fields-->
					<div class="form-group">
						<label for="activity_addr" class="control-label col-lg-3">Adresse de votre activité</label>
						<div class="col-lg-9">
							<input type="text" class="form-control" name="activity_addr" id="activity_addr" placeholder="Adresse de votre activité" maxlength="500" required=""
							value="{if isset($bookingProductInfo) }{$bookingProductInfo.activity_addr}{/if}"
							>
						</div>
					</div>
					<div class="form-group">
						<label for="activity_city" class="control-label col-lg-3">Ville de votre activité</label>
						<div class="col-lg-9">
							<input type="text" class="form-control input_left" name="activity_city" id="activity_city" placeholder="Ville de votre activité" maxlength="80" required=""
							value="{if isset($bookingProductInfo) }{$bookingProductInfo.activity_city}{/if}"
							>
						</div>
					</div>
					<div class="form-group">
						<label for="activity_city" class="control-label col-lg-3">Code postal de votre activité</label>
						<div class="col-lg-9">
							<input type="text" class="form-control input_right" name="activity_postcode" id="activity_postcode" placeholder="Code postal de votre activité" maxlength="6" required=""
					...
					<div class="form-group">
						<label for="activity_city" class="control-label col-lg-3">Durée de l'activité</label>
						<div class="col-lg-9">
					...
					<div class="form-group">
						<label for="activity_curious" class="control-label col-lg-3">Curieux concernés</label>
						<div class="col-lg-9">
							<select name="activity_curious" id="activity_curious" class="form-control" data-placeholder="Curieux concernés">
									...
									<option value="Personnes à mobilité" {if isset($bookingProductInfo) && $bookingProductInfo.activity_curious == 'Personnes à mobilité' }selected{/if}>Personnes à mobilité</option>
							</select>
						</div>
					</div>
					<div class="form-group">
						<label for="activity_material" class="control-label col-lg-3">Matériel à prévoir (optionnel)</label>
						<div class="col-lg-9">
							<input type="text" class="form-control input_right" name="activity_material" id="activity_material" placeholder="Matériel à prévoir (optionnel)" maxlength="500"
