              ...
              <tr>
                ...
                <td>
                  <font size="2" face="Open-sans, sans-serif" color="#555454">
					...
					<br>
					Boutique : {$product['mp_seller_info']['shop_name_unique']}<br>
					Artisan : {$product['mp_seller_info']['seller_firstname']} {$product['mp_seller_info']['seller_lastname']}<br>
					Email de l'artisan : {$product['mp_seller_info']['business_email']}<br>
					...
					Durée de l'activité: {$product['bookingProductInfo']['activity_period']}<br>
                  </font>
                </td>
                <td width="10">&nbsp;</td>
              </tr>
