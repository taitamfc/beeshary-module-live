...
class AdminLeoblogBlogsController extends ModuleAdminController
{
    ...
    public function renderForm()
    {
        ...
        if ($this->object->image) {
            # validate module
            if (apPageHelper::getThemeName()) {
                $thumb = _THEMES_DIR_.apPageHelper::getThemeName().'/assets/img/modules/leoblog/'.$id_shop.'/b/'.$this->object->image;
            } else {
                $thumb = PS_THEME_DIR_.'/assets/img/modules/leoblog/'.$id_shop.'/b/'.$this->object->image;
            }
        } else {
            # validate module
            $thumb = '';
        ...
        if ($this->object->thumb) {
            # validate module
            if (apPageHelper::getThemeName()) {
                $thumb_img = _THEMES_DIR_.apPageHelper::getThemeName().'/assets/img/modules/leoblog/'.$id_shop.'/b/'.$this->object->thumb;
            } else {
                $thumb_img = PS_THEME_DIR_.'/assets/img/modules/leoblog/'.$id_shop.'/b/'.$this->object->thumb;
            }
        } else {
            # validate module
            $thumb_img = '';
    ...
    {
        if (apPageHelper::getThemeName()) {
            $folder_theme = _PS_ROOT_DIR_.'/themes/' .apPageHelper::getThemeName().'/';
        } else {
