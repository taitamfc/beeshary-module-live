...
class Pspixel extends Module
{
    ...
    public function install()
    {
        ...
        \Configuration::updateValue('PS_FACEBOOK_PIXEL_DATE_INSTALL', $now->format('Y-m-d H:i:s'));
    ...
    {
        \Configuration::deleteByName('PS_PIXEL_ID');
        \Configuration::deleteByName('PS_FACEBOOK_PIXEL_DATE_INSTALL');
    ...
    public function getContent()
    {
        ...
        $showRateModule = \DateTime::createFromFormat('Y-m-d H:i:s', \Configuration::get('PS_FACEBOOK_PIXEL_DATE_INSTALL'));
        $now = new \DateTime('now');
