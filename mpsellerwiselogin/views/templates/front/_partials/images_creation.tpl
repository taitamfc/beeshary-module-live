...
<div id="sellerImagesForm" style="display: none;">
   ...
   <div>
    <img class="center-block store_top_pic" src="{$urls.base_url}themes/beeshary_child/assets/img/picto-boutique.jpg" />
    <div class="pp_seller_profile_title">{l s='My store' mod='mpsellerwiselogin'}</div>
    <div class="pp_seller_profile_subtitle">Il vous sera possible d'ajouter des images qui vous ressemblent pour présenter votre univers et vos produits directement sur la partie <span style="font-weight:bold;">journal de bord</span> de votre boutique</div>
  </div>
