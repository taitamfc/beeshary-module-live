  ...
  <div id="sellerProfileForm" style="display:block;">
    ...
    <div class="form-group">
		...
		<select id="pp_theme" name="pp_theme" class="form-control">
			<option value="1">Agriculture, production et élevage</option>
			...
			<option value="7">Confitures & Gourmandises sucrées</option>
			<option value="8">Cosmétiques & produits de bien-être</option>
			<option value="9">Création de bijoux</option>
			<option value="10">Epicerie salée et conserverie</option>
			<option value="11">Gastronomie et Métiers de bouche</option>
			<option value="12">Insolite</option>
			<option value="13">Mobilier & décoration</option>
			<option value="14">Nature & botanique</option>
			<option value="15">Papier & calligraphie</option>
			<option value="16">Pierre & Marbre</option>
			<option value="17">Poterie & Céramique</option>
			...
			<option value="22">Travail du Métal</option>
