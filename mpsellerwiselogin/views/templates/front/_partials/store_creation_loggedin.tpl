...
<div id="sellerStoreForm" style="display: none;">
	...
	<p style="text-align:center;">Nom visible dans l'url. Ex: https://beeshary.com/boutique/URL-BOUTIQUE</p>
	<div class="form-group">
		<textarea class="form-control" name="store_description" id="store_description" placeholder="{l s='Store description' mod='mpsellerwiselogin'}">{if isset($smarty.post.store_description)}{$smarty.post.store_description|escape:'htmlall':'utf-8'}{/if}</textarea>
	</div>
	{if isset($extrafields)}
		<div class="form-group">
			{if $extrafields.labels.attribute_name == 'labels' }
				...
				<select class="form-control has-chosen" style="overflow: hidden;" id="labels" name="labels[]" multiple data-placeholder="{l s='My labels and certificates' mod='mpsellerwiselogin'}*" required>
	...
	<div class="form-group">
		<div class="input-group">
			<input type="password" class="form-control" name="passwd" id="passwd" placeholder="Mot de passe* (min 5 caractères)" required />
			<div class="input-group-addon">
