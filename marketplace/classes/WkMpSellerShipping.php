...
class WkMpSellerShipping extends ObjectModel
{
    ...
    /**
     * Get Shipping record by using Order ID
     *
     * @param  int $idOrder Order ID
     * @return array/boolean
     */
    public function getShippingByIdOrder($idOrder)
    {
        return Db::getInstance()->getRow('SELECT * FROM `'._DB_PREFIX_.'wk_mp_seller_shipping`
