...
class EventDataFactory
{
    ...
    public static function prepareOrderPayload($customer, $order)
    {
        ...
        $orderPayload->id = sprintf('cart:%s', $order->id_cart);
    ...
    private static function prepareProduct($item)
    {
        ...
        $cartItem->price_predisc = $item['price_without_reduction'];
        $cartItem->price_predisc_taxinc = $item['price_without_reduction_without_tax'];
        $cartItem->price_taxinc = $item['price_with_reduction'];
        $cartItem->disc_amount = $item['reduction_without_tax'];
        $cartItem->disc_amount_taxinc = $item['reduction'];
        $cartItem->disc_rate = '';
        $cartItem->tax_amount = $item["price_without_reduction"] - $item["price_without_reduction_without_tax"];
    ...
    public static function getTransactionalOrderPayload($email, $order)
    {
        ...
        $transactionalOrderPayload->orderId = $order->id;
