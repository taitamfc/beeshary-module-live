...
class Psmailin
{
    ...
    */
    ...
    {
        return $this->post("account", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->put("account", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("account/getchildv2", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("account/addrmvcredit", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->get("campaign/detailsv2", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("campaign", Tools::jsonEncode($data));
    }
    ...
    */
    public function updateCampaign($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->put("campaign/".$id, Tools::jsonEncode($data));
    }
    ...
    */
    public function campaignReportEmail($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->post("campaign/".$id."/report", Tools::jsonEncode($data));
    }
    ...
    */
    public function campaignRecipientsExport($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->post("campaign/".$id."/recipients", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("campaign/sharelinkv2", Tools::jsonEncode($data));
    }
    ...
    */
    public function sendBatEmail($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->post("campaign/".$id."/test", Tools::jsonEncode($data));
    }
    ...
    */
    public function updateCampaignStatus($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->put("campaign/".$id."/updatecampstatus", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->get("folder", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("folder", Tools::jsonEncode($data));
    }
    ...
    */
    public function updateFolder($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->put("folder/".$id, Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->get("list", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("list", Tools::jsonEncode($data));
    }
    ...
    */
    public function updateList($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->put("list/".$id, Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("list/display", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    public function addUsersList($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->post("list/".$id."/users", Tools::jsonEncode($data));
    }
    ...
    */
    public function deleteUsersList($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->delete("list/".$id."/delusers", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("attribute/", Tools::jsonEncode($data));
    }
    ...
    */
    public function deleteAttribute($type, $data)
    {
        $type = $data['type'];
        unset($data['type']);
        return $this->post("attribute/".$type, Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("user/createdituser", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("user/import", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("user/export", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->get("process", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
            return $this->get("webhook", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("webhook", Tools::jsonEncode($data));
    }
    ...
    */
    public function updateWebhook($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->put("webhook/".$id, Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->get("advanced", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("advanced", Tools::jsonEncode($data));
    }
    ...
    */
    public function updateSender($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->put("advanced/".$id, Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("email", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("statistics", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("report", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("bounces", Tools::jsonEncode($data));
    }
    ...
    */
    public function sendTransactionalTemplate($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->put("template/".$id, Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("template", Tools::jsonEncode($data));
    }
    ...
    */
    ...
    {
        return $this->post("sms", Tools::jsonEncode($data));
    }
    ...
    */
    public function updateSmsCampaign($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->put("sms/".$id, Tools::jsonEncode($data));
    }
    ...
    */
    ...
    /*
        Delete transaction attribute data.
        @param {Array} data contains php array with key email and transaction_id pair.
        @options data {String} to:  .
    */
    public function deleteTransnationalAttributeValue($data = array())
    {
        return $this->post("attribute/delete_transnational_attribute_value", json_encode($data));
    }
}
