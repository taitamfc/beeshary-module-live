...
class ProductService
{
    ...
    public function getProducts($term, $page, $itemsPerPage)
    {
        ...
        $defaultLanguage = \ConfigurationCore::get('PS_LANG_DEFAULT');
        $idLang = !empty($defaultLanguage) ? $defaultLanguage : \ContextCore::getContext()->language->id;
        ...
        $sqlTable = [
            ...
            'shop' => [
                'table' => 'shop',
                'join' => 'LEFT JOIN',
                'on' => sprintf('shop.id_shop = %s', $idShop),
            ],
            'image_shop' => [
                'table' => 'image_shop',
                'join' => 'LEFT JOIN',
        ...
        foreach ($products as &$product) {
            ...
            $product['price_final'] = \ProductCore::getPriceStatic(
                ...
                true,
                null,
                \ContextCore::getContext()->getComputingPrecision(),
                null,
                false,
                true,
                1,
